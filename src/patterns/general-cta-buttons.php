 ...
 * Slug: wds-text/general-cta-buttons
 * Categories: wds-text
 * Viewport Width: 1280
 */
...
<p class="has-large-font-size" style="line-height:1.5">Lorem ipsum dolor sit amet, consectetur adipiscing lectus. Vestibulum mi justo, luctus pellentesque vitae gravida non.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
