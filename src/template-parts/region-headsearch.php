...
<path class="st1" d="M18.12,2.62v5.23h-1.94c0-0.96-0.95-1.74-2.13-1.74c-0.86,0-1.6,0.42-1.94,1.02v6.54
    ...
    <ul class="list-inline ml-auto mb-0">
      <li class="nav-item list-inline-item"><a href="https://my.utk.edu" class="nav-link text-light">myUTK</a></li>
      <li class="nav-item list-inline-item"><a href="https://apply.utk.edu" class="nav-link text-light">Apply</a></li>
      ...
      <li class="nav-item list-inline-item">
        <button class="navbar-toggler" type="button" id="mobile-menu-open" data-toggle="site-navigation"><span class="navbar-toggler-icon"></span><span class="sr-only">Menu</span></button>
      </li>
    </ul>
