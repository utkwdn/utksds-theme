...
?>
  <nav class="navbar navbar-dark bg-smokey">
    ...
    <span class="d-none d-md-inline small">University of Tennessee, Knoxville</span></a>
    <ul class="list-inline ml-auto mb-0">
      <li class="nav-item list-inline-item"><small><a href="https://giveto.utk.edu" class="nav-link text-light text-uppercase">Give</a></small></li>
      <li class="nav-item list-inline-item"><small><a href="https://my.utk.edu" class="nav-link text-light text-uppercase">myUTK</a></small></li>
      <li class="nav-item list-inline-item"><small><a href="https://apply.utk.edu" class="nav-link text-light text-uppercase">Apply</a></small></li>
