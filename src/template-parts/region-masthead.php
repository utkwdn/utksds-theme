  ...
  if ( get_header_image() ) : ?>
	...
	<header id="masthead" class="site-header">
      ...
      if ( has_custom_logo() ) { ?>
  				...
  				<div class="col-5 mx-auto mx-md-0 col-sm-7 col-md-10 col-lg-4 col-xl-4 d-flex justify-content-center justify-content-lg-start">
      ...
      if ( is_front_page() && is_home() ) :
				?>
  				<div class="col-5 mx-auto mx-md-0 col-sm-7 col-md-10 col-lg-4 col-xl-4 d-flex justify-content-center justify-content-lg-start">
    				<a class="text-reset text-decoration-none text-uppercase font-weight-light d-flex" id="site-link" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
     				<h1 class="h6 site-title font-weight-light d-flex align-self-center mb-0"><?php bloginfo( 'name' ); ?></a></h1>
  				</a>
				</div>
				<?php  else : ?>
  				...
  				<div class="col-5 mx-auto mx-md-0 col-sm-7 col-md-10 col-lg-4 col-xl-4 d-flex justify-content-center justify-content-lg-start">
    				<a class="text-reset text-decoration-none text-uppercase font-weight-light d-flex" id="site-link" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
     				<span class="h6 site-title font-weight-light d-flex align-self-center mb-"><?php bloginfo( 'name' ); ?></a></span>
  				</a>
				</div>
